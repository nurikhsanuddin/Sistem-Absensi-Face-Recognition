...
def generate_dataset(nbr):
    face_classifier = cv2.CascadeClassifier("D:/laragon/www/citra digital/resources/haarcascade_frontalface_default.xml")
...
def train_classifier(nbr):
    dataset_dir = "D:/laragon/www/citra digital/dataset"
...
def face_recognition():  # generate frame by frame from camera
    ...
    faceCascade = cv2.CascadeClassifier("D:/laragon/www/citra digital/resources/haarcascade_frontalface_default.xml")
    clf = cv2.face.LBPHFaceRecognizer_create()
